...
ActiveRecord::Schema.define(version: 2020_11_18_134359) do
  ...
  create_table "lotteries", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.integer "product_id"
    t.string "result"
    t.integer "poind_id"
    t.string "image"
  ...
  create_table "user_products", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.integer "user_id"
    t.integer "product_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
